...
import ImageArticle_1 from './../assets/images/article_1.png';
import ImageArticle_2 from './../assets/images/article_2.png';
import ImageArticle_3 from './../assets/images/article_3.png';
...
export const ConfSite = {
   ...
   partner: [
      ...
      { image: ImagePaterner3 },
      { image: ImagePaterner4 },
   ],
   abouts: {
      title: '',
      content: '',
   ...
   actuality: [
      {
         image: ImageArticle_1,
         title: 'Adresse à la nation du chef de l’Etat, Colonel Mamadi DOUMBOUYA',
         content: `uinéennes et Guinéens, Mes Chers Compatriotes,
